...
@section('head_title'){{__('All Locales')}}@endsection
@push('styles')
    <style>
        .activeme {
            background: #3f51b51f;
                ...
                <div class="col-12">
                    <div class="card" id="page_layout">
                        ...
                        <div class="card-header border-bottom">
                            ...
                            @if(permissionCheck('locales.create') || permissionCheck('locales.update') || permissionCheck('locales.delete'))
                                    ...
                                    <div class="form-group ">
                                        <div class="col-lg-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2">
                                                    @if(permissionCheck('locales.delete'))
...
@push('scripts')
    {!! vue_srcs() !!}
    <script>
        var locale_index = "{{ route('app.locales.store') }}";
        var locale_store = "{{ route('app.locales.show',1) }}";
        new Vue({
            el: '#page_layout',
            data: {
                index: '',
